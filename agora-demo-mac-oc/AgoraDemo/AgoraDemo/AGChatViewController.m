...
- (void)initAgoraKit {
    ...
    self.agoraKit = [AgoraRtcEngineKit sharedEngineWithAppId:config.vendorKey delegate:self];
    [self.agoraKit setChannelProfile:config.channelProfile];
    
    if (config.videoEnabled) {
        [self.agoraKit enableVideo];
//        [self.agoraKit setVideoProfile:config.videoProfile swapWidthAndHeight:false];
    } else {

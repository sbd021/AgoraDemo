...
if (navigator.mozGetUserMedia) {
  ...
  reattachMediaStream = function(to, from) {
    ...
    var installPlugin = function () {
        ...
        if (pluginObj.isWebRtcPlugin || (typeof navigator.plugins !== "undefined" && (!!navigator.plugins["AgoraWebRtcPlugin"] || !!navigator.plugins["WebRTC Everywhere"] || navigator.plugins["WebRTC Everywhere Plug-in for Safari"]))) {

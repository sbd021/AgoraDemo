$(document).ready(function(window){
  ...
  $(".audioSwitch").on("click", function(e){
    ...
    if(disableAudio){
       ...
       $(".audioSwitch div").removeClass("on").addClass("off").html("Enabled audio");
    }
    else{
        localStream.enableAudio(); 
       $(".audioSwitch div").removeClass("off").addClass("on").html("Mute");
    }
  });
  /* 打开Camera Off */
  $(".videoSwitch").on("click", function(e){
    ...
    if(disableVideo){
      ...
      $(".videoSwitch div").removeClass("on").addClass("off").html("Camera On");
    }
    else{
      localStream.enableVideo();
      $(".videoSwitch div").removeClass("off").addClass("on").html("Camera Off");
    }
  });
  /* Switch View */
